  ...
  <div>
    ...
    <Form validate-first @submit="onSubmit" class="boxfont">
      ...
      <div class="id">
        ...
        <CellGroup>
          <Field label="姓名" v-model="username" name="username" placeholder="姓名" />
          <Field label="宿舍余额" v-model="money" name="money" placeholder="宿舍余额" />
          <Field label="宿舍长" v-model="moniter" name="moniter" placeholder="宿舍长" />
...
import { Form, Button, Field, Toast, CellGroup, Dialog } from 'vant'
export default {
  data () {
    return {
      buildingId: '',
