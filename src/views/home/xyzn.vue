<template>
  <div>
    <navigation left="back" title="小抽奖"></navigation>
    <div class="lottery-box" id="app">
      <h1 class="title">小抽奖</h1>
      <div class="lottery">
      ...
      <div class="lottery-alert" v-if="showToast">
        <h1>恭喜您</h1>
        <p><img src="../../assets/game/j2.png" alt=""></p>
...
var imgurl1 = require('../../assets/game/j1.png')
var imgurl2 = require('../../assets/game/j2.png')
export default {
  data () {
    return {
      isStart: 1,
  ...
  mounted () {
    document
      .querySelector('body')
      .setAttribute('style', 'background: radial-gradient(49% 160% at 0 0, #22b5ff 0, #3a72fa 100%)')
  },
  beforeDestroy () {
...
<style scoped>
  * {
  ...
  body {
    background: radial-gradient(49% 160% at 0 0, #22b5ff 0, #3a72fa 100%);
    font-size: 14px;
  }
  ...
  @keyframes changeBg {
    0% {
      background-image: url(../../assets/game/k1.png);
    }

    100% {
      background-image: url(../../assets/game/k2.png);
    }
  }
  ...
  .lottery .lottery-item ul li .box {
    ...
    text-align: center;
    overflow: hidden;
    background: url(../../assets/game/bg2.png) no-repeat center;
    background-size: 100% 100%;
  }
  ...
  .lottery .lottery-item ul li.on .box {
    background: url(../../assets/game/bg1.png) no-repeat center;
    background-size: 100% 100%;
  }
  ...
  .lottery .lottery-item .lottery-start .box.gray {
    background: url(../../assets/game/bg3.png) no-repeat center;
    background-size: 100% 100%;
  }
